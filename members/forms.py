...
class UserRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password2'].widget = forms.PasswordInput(attrs={'placeholder':'Retype Password'})

class LoginForm(forms.Form):
    username = forms.CharField(max_length = 20,widget=forms.TextInput(attrs={'placeholder':'Username'}),label='')
...
class ProfileUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = ProfileInfo
        fields = ['display_picture','bio','website_url','facebook_url','twitter_url','youtube_url','linkedin_url']
